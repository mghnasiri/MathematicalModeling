"""Tests for Ant Colony Optimization on CVRP."""
...
_inst = _load_mod("cvrp_instance_test_aco", os.path.join(_parent_dir, "instance.py"))
...
class TestCVRPACOQuality:
    """Test solution quality."""

    def test_aco_competitive_with_cw(self):
        inst = small6()
        cw_sol = clarke_wright_savings(inst)
        aco_sol = ant_colony(inst, max_iterations=100, seed=42)
        assert aco_sol.distance <= cw_sol.distance * 1.1
