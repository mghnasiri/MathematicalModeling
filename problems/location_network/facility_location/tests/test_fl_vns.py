"""Tests for Variable Neighborhood Search on Facility Location (UFLP)."""
...
_inst = _load_mod("fl_instance_test_vns", os.path.join(_parent_dir, "instance.py"))
...
class TestFLVNSQuality:
    ...
    def test_vns_competitive_with_greedy(self):
        ...
        assert vns_sol.cost <= greedy_sol.cost * 1.05
